...
const navItems: NavItem[] = [
  ...
  { to: appConfig.routes.incidents, label: 'Incident Queue', icon: Inbox, badge: 'live' },
  { to: appConfig.routes.runbooks, label: 'Runbooks', icon: GitBranch },
  { to: appConfig.routes.knowledgeBase, label: 'Knowledge Base', icon: BookOpen },
  { to: '/knowledge-graph', label: 'Knowledge Graph', icon: Network },
  { to: appConfig.routes.escalations, label: 'Escalations', icon: AlertOctagon, roles: ['engineer', 'admin'] },
